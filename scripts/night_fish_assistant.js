...
function cycleAssistantSpeech() {
    updateThemeVariables();
    const data = COGNITION_DATA[messageIndex];
    const phrase = data[config.activeLang] || data['EN'];
    speak(phrase);
    messageIndex = (messageIndex + 1) % COGNITION_DATA.length;
}

// Burst command helper
function triggerBubbleStorm() {
...
// Setup floating widget and chat structures
function injectWidgetElements() {
    ...
    widget.innerHTML = `
        ...
        <div class="avatar-img-container">
            <img src="assets/crew/night_fish/images/night_fish_Night%20fish%20for%20afx%20holo.png" alt="Night Fish Avatar">
        </div>
    ...
    chatPanel.innerHTML = `
        ...
        <div class="chat-body">
            ...
            <div class="chat-footer-label">TIM DWEN DIGITAL INSTRUMENT SUITE</div>
        </div>
    `;
    ...
    holoOverlay.innerHTML = `
        ...
        <div class="holo-container">
            <div class="holo-image-wrap">
                ...
                <img src="assets/crew/night_fish/images/night_fish_Night%20fish%20for%20afx%20holo.png" alt="Holo Night Fish">
            </div>
